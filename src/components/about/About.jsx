...
import AboutImg from "../../assets/profile-2.jpg";
import { FaRegAddressCard } from "react-icons/fa6";
import CV from '../../assets/Khalil_Resume.pdf';
      ...
      <div className="about-container container grid">
        ...
        <div className="about-data">
          ...
          <div className="about-peragraph-section">
            <p className="about-p">
              Hi! I'm Muhmmad Khalil Ur Rehman, a passionate software developer with a keen
